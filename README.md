...
A Serverless plugin that creates an AWS API Gateway Resource connected to an AWS Simple Queue Service (SQS) without the use of a lambda. More info please refer to: https://coderecipe.ai/architectures/17547953
